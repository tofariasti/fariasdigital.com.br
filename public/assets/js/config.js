...
Obrigado!`,
    ...
    pacoteLandingAdmin: 'Olá! Tenho interesse no pacote Landing + Painel (base a partir de R$ 890; pet/creche a partir de R$ 1.190). Gostaria de um orçamento.',
  ...
  pacotesWeb: [
    ...
    },
    {
      id: 'landing-painel',
      nome: 'Landing + Painel',
      preco: 'base R$ 890 · pet a partir de R$ 1.190',
      publico: 'Quem quer autonomia real — painel 100% sob medida, não um pacote travado',
      inclui: [
        'Tudo da Landing Page personalizada',
        'Painel 100% customizável no celular — aparência de app nativo',
        'Com a sua identidade visual (logo, cores, fontes e tom)',
        'Base típica (a partir de R$ 890): textos, preços, fotos, horário e WhatsApp',
        'Com regras de negócio (ex.: pet/creche, reservas): a partir de R$ 1.190',
        'Treinamento rápido na entrega + suporte humano quando precisar',
      ],
      naoInclui: 'Domínio e hospedagem (orçáveis à parte). Quanto mais complexo o painel, maior o investimento.',
  ...
  demos: [
    ...
    {
      titulo: 'Luna Valente — Astrologia',
      segmento: 'Astrologia',
      url: 'https://tofariasti.github.io/landing-astrologo/',
      badge: 'Landing + Admin',
      descricao: 'Landing de conversão (SignFinder, WhatsApp) + painel demo para clientes, consultas e serviços astrológicos — sem backend.',
    },
    {
      titulo: 'Cosmos Diário — Horóscopo',
      segmento: 'Astrologia',
      url: 'https://tofariasti.github.io/landing-horoscopo/',
      badge: 'Landing + Admin',
      descricao: 'Portal editorial (HoroscopePicker diário, WhatsApp) + painel demo para edições e leituras por signo — sem backend.',
    },
    {
      titulo: 'Céu & Números — Numerologia',
      segmento: 'Astrologia',
      url: 'https://tofariasti.github.io/landing-numerologia/',
      badge: 'Landing + Admin',
      descricao: 'Landing de conversão (caminho de vida, WhatsApp) + painel demo para clientes, relatórios e serviços — sem backend.',
    },
    {
  ...
  servicos: [
    {
      ...
      descricao: 'Site + painel customizável — base R$ 890; pet/creche a partir de R$ 1.190.',
      preco: 'base R$ 890 · pet a partir de R$ 1.190',
      href: '/pacotes/#pacotes',
    },
    {
  ...
  cases: [
    {
      ...
      imagem: '/assets/img/cases/techdrone360.png',
    },
    {
      ...
      imagem: '/assets/img/cases/ibge-localidades.png',
    },
  ],

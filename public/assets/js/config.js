...
Obrigado!`,
    ...
    pacoteLandingAdmin: 'Olá! Tenho interesse no pacote Landing + Painel (base a partir de R$ 890; pet/creche a partir de R$ 2.400). Gostaria de um orçamento.',
  ...
  pacotesWeb: [
    ...
    },
    {
      id: 'landing-painel',
      nome: 'Landing + Painel',
      preco: 'base R$ 890 · pet a partir de R$ 2.400',
      ...
      inclui: [
        ...
        'Com regras de negócio (ex.: pet/creche, reservas): a partir de R$ 2.400',
  ...
  servicos: [
    {
      ...
      descricao: 'Site + painel customizável — base R$ 890; pet/creche a partir de R$ 2.400.',
      preco: 'base R$ 890 · pet a partir de R$ 2.400',
      href: '/pacotes/#pacotes',
    },
    {

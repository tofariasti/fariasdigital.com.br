...
Obrigado!`,
  ...
  demos: [
    ...
    },
    {
      ...
      segmento: 'Turismo',
      url: 'https://tofariasti.github.io/turismo-picadacafe-landing/',
      descricao: 'Atrativos da Cidade dos Lírios, eventos da Rota Romântica e agendamento de visitas via WhatsApp.',
    },
    {
      titulo: 'Canela — Turismo',
      segmento: 'Turismo',
      url: 'https://tofariasti.github.io/turismo-canela-landing/',
      descricao: 'Catedral de Pedra, Caracol, Skyglass e eventos como Sonho de Natal na Serra Gaúcha.',
    },
    {
      titulo: 'Gramado — Turismo',
      segmento: 'Turismo',
      url: 'https://tofariasti.github.io/turismo-gramado-landing/',
      descricao: 'Lago Negro, Rua Coberta, Natal Luz e roteiros premium com agendamento via WhatsApp.',
    },
    {
      titulo: 'Porto Alegre — Turismo',
      segmento: 'Turismo',
      url: 'https://tofariasti.github.io/turismo-portoalegre-landing/',
      descricao: 'Mercado Público, Redenção, Usina do Gasômetro e eventos culturais da capital gaúcha.',
    },
    {
      titulo: 'Passo Fundo — Turismo',
      segmento: 'Turismo',
      url: 'https://tofariasti.github.io/turismo-passofundo-landing/',
      descricao: 'Capital Nacional da Literatura, Parque da Gare, rodeio e patrimônio cultural do Norte gaúcho.',
    },
    {
      titulo: 'Ivoti — Turismo',
      segmento: 'Turismo',
      url: 'https://tofariasti.github.io/turismo-ivoti-landing/',
      descricao: 'Cidade das Flores, Núcleo Enxaimel, colônia japonesa e feiras coloniais na Rota Romântica.',
    },
    {
      titulo: 'São Francisco de Paula — Turismo',
      segmento: 'Turismo',
      url: 'https://tofariasti.github.io/turismo-saofranciscodepaula-landing/',
      descricao: 'Lago São Bernardo, ecoturismo nos Campos de Cima da Serra e pousadas charmosas.',
    },
    {
      titulo: 'Ametista do Sul — Turismo',
      segmento: 'Turismo',
      url: 'https://tofariasti.github.io/turismo-ametistadosul-landing/',
      descricao: 'Capital mundial da ametista — minas, vinícola subterrânea e Parque Museu com geodos.',
    },
    {
      titulo: 'Salto do Yucumã — Turismo',
      segmento: 'Turismo',
      url: 'https://tofariasti.github.io/turismo-saltodoyucuma-landing/',
      descricao: 'Maior queda d\'água longitudinal do mundo no Parque Estadual do Turvo — roteiro noroeste RS.',
    },
    {

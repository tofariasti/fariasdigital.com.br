...
export const pacotesWebLocalized = [
  ...
  },
  {
    ...
    preco: L('base R$ 890 · pet a partir de R$ 2.400', 'base R$ 890 · pet from R$ 2,400', 'base R$ 890 · pet desde R$ 2.400'),
    publico: L(
    ...
    inclui: [
      ...
      L('Com regras de negócio (ex.: pet/creche, reservas): a partir de R$ 2.400', 'With business rules (e.g. pet/daycare, bookings): from R$ 2,400', 'Con reglas de negocio (ej.: pet/guardería, reservas): desde R$ 2.400'),
...
export const portfolioLocalized = {
  ...
  grupoPainel: {
    ...
    lead: L(
      'Abra o site e teste um painel demo no celular. Painel base a partir de R$ 890; com regras de negócio (ex.: pet/creche) a partir de R$ 2.400 — 100% customizável, sem pacote travado.',
      'Open the site and try a demo panel on your phone. Base panel from R$ 890; with business rules (e.g. pet/daycare) from R$ 2,400 — fully customizable, not a locked package.',
      'Abra el sitio y pruebe un panel demo en el celular. Panel base desde R$ 890; con reglas de negocio (ej.: pet/guardería) desde R$ 2.400 — 100% personalizable, sin paquete cerrado.',
    ),
  },
...
export const servicosLocalized = [
  { id: 'landing-painel', titulo: L('Landing + Painel', 'Landing + Panel', 'Landing + Panel'), descricao: L('Site + painel customizável — base R$ 890; pet/creche a partir de R$ 2.400.', 'Website + custom panel — base R$ 890; pet/daycare from R$ 2,400.', 'Sitio + panel personalizable — base R$ 890; pet/guardería desde R$ 2.400.'), preco: L('base R$ 890 · pet a partir de R$ 2.400', 'base R$ 890 · pet from R$ 2,400', 'base R$ 890 · pet desde R$ 2.400'), href: '/pacotes/#pacotes' },
